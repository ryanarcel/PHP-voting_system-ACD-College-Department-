        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                if(isset($_GET['id'])) {
                    ...
                    echo "<div class='alert alert-danger'>Are you sure you want to delete selected Vote? <a href='reviewresult.php?del_id=$org_id'>Yes</a> | <a href='studentvote.php'>No</a></div>";
                }
                ...
                if(isset($_GET['del_id'])) {
                    ...
                    $hopeless = new Voting();
                    $rtnhopeless = $hopeless->HOPELESS($id_to_del);
                    if($rtnhopeless){
                    ...
                    $delOrg = new Voting();
                    $rtnDelOrg = $delOrg->DELETE_VOTE($id_to_del, $hope);
                }
                ?>
            </div>
        </div>
