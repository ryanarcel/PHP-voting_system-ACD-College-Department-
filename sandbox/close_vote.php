...
$rtnReadOrg = $readOrganization->READ_ORG($types);
?>
<div class="container">
<?php if($rtnReadOrg) { ?>
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <h3 style="text-align: center;">Select Election to Close</h3><hr />
            <h4>Welcome Admin</h4>
            <?php
            if(isset($_POST['submit'])) {
                ...
                $closeVote = new Organization();
                $rtnCloseVote = $closeVote->CLOSE_ORG($org);
                $rtnCloseVoted = $closeVote->CLOSE_ORGS($ors,$mydate);
                $rtnCloseVoteds = $closeVote->CLOSE_NA($orc);
                $rtnCloseVotedsV = $closeVote->CLOSE_NAGYUD($orc, $mydate);
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" role="form">
                <div class="form-group">
                    ...
                    <select name="org" required class="form-control" name="organization">
