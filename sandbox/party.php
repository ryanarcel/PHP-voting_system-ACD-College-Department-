    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="add_voters.php"><span class="glyphicon glyphicon-eye-open"></span>View Voters</a></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><span class="glyphicon glyphicon-plus-sign"> C / O Election</span></a>
...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            <h4>Welcome Admin</h4>
            <?php if($rtnReadParty) { ?>
            <form action="party_result.php" method="GET" role="form">
