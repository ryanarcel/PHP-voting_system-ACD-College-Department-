...
<div class="container">
    <div class="row">
        ...
        $readNominees = new Position();
        $rtnReadNominees = $readNominees->READ_POS($types);
        ?>
        <div class="col-md-8">
            <h4>List of Elections and Positions</h4><hr>
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="nominees.php?id=<?php echo $rowNom['org']; ?>&amp;pos=<?php echo $rowNom['pos']; ?>&amp;posId=<?php echo $rowNom['id']?>"><span class="glyphicon glyphicon-plus"></span>Add Nominee</a></td>
                        <td><a href="views.php?org=<?php echo $rowNom['org']; ?>&amp;pos=<?php echo $rowNom['pos']; ?>"><span class="glyphicon glyphicon-eye-open"></span>View Nominee</a></td>
                    </tr>
                    <?php } //End while ?>
                </table>
