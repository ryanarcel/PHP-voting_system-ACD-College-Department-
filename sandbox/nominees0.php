                ...
                <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>" role="form">
                  ...
                  //  $types = $_SESSION['ADMIN_TYPE'];
                    ...
                    <label for="stud_id">Student ID Number</label>
                      ...
                      <?php if($rtnReadStud) { ?>
                        <select required name="stud_id" class="form-control" onchange="getPos(this.value);" >
                            <option value="">*****Select Student ID*****</option>
                            <?php while($rowStud = $rtnReadStud->fetch_assoc()) { ?>
                                <option value="<?php echo $rowStud['stud_id']; ?>"><?php echo $rowStud['stud_id']; ?></option>
                            <?php } //End while ?>
                    </select>
                        <?php $rtnReadStud->free(); ?>
                        <?php } //End if
                    ...
                    <select name="name" class="form-control" id="poslist">
                    </select>
                    </div>
                    <hr/>
                    <div class="form-group-sm">
                        <input type="submit" name="submit" value="Add Nominee" class="btn btn-info">
                    </div>
                </form>
