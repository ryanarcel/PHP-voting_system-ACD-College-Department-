...
<?php if($rtnReadOrg) { ?>
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <h3 style="text-align: center;">Select Election to Reopen</h3><hr />
            <h4>Welcome Admin</h4>
            <?php
            if(isset($_POST['submit'])) {
                ...
                $ReOpenVote = new Organization();
                $rtnReOpenVote = $ReOpenVote->REOPEN_ORG($org);
                $rtnReOpenVoted = $ReOpenVote->REOPEN_ORGS($ors);
                $rtnReOpenVoteds = $ReOpenVote->REOPEN_ORGSS($orc);
