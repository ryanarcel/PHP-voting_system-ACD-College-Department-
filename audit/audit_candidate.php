                            ...
                            <table class="table table-condensed table-striped">
                                ...
                                <?php while($rowCountVotes = $rtnReadNomOrgPos->fetch_assoc()) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 30%;"><?php echo $rowCountVotes['name']; ?></td>
                                        <td style="width: 30%;"><?php echo $rowCountVotes['party']; ?></td>
                                        <td style="width: 10%;"><?php echo $rtnCountVotes->num_rows; ?></td>
                                        <td style="width: 10%;"><?php echo $rowCountVotes['close_date']; ?></td>
                                        <td style="width: 10%;"><a href="audit_result.php?org=<?php echo $rowCountVotes['id']; ?>&amp;pos=<?php echo $rowCountVotes['name']; ?>"><span class="glyphicon glyphicon-eye-open"></span></a></td>
                                    </tr>
